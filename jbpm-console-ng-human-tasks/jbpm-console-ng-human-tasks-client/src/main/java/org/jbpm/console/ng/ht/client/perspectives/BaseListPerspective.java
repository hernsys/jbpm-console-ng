 ...
 */
@ApplicationScoped
@WorkbenchPerspective(identifier = "BaseList", isDefault = false)
public class BaseListPerspective {
    ...
    public PerspectiveDefinition getPerspective() {
        ...
        p.setName( "Tasks" );
        p.getRoot().addPart( new PartDefinitionImpl( new DefaultPlaceRequest( "Base List" ) ) );
        p.setTransient( true );
        return p;
    }
