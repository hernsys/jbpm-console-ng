...
public class UsageEventSummary extends UsageResourceEvent implements Serializable {
    ...
    public UsageEventSummary(String itemPath, String note, String userFrom){
    	super(itemPath, note, userFrom);
    }
    ...
    public String toString() {
        return "UsageEventSummary [key=" + key + ", timestamp=" + timestamp + ", module=" + module + ", component=" + component
                + ", action=" + action + ", user=" + user + ", level=" + level + ", status=" + status + ", description="
                + description + "]";
    }
